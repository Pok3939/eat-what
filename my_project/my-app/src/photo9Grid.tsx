...
class Grid extends React.Component<CounterProps> {
    render() {
        ...
        const layout = [
            {i: '4', x: 0, y: -3, w: 2, h: 7, static:true},
            {i: '5', x: 2, y: -3, w: 2, h: 7, static:true},
            {i: '6', x: 4, y: -3, w: 2, h: 7, static: true},
            {i: '7', x: 0, y: 0, w: 2, h: 7, static: true},
            {i: '8', x: 2, y: 0, w: 2, h: 7, static: true},
            {i: '9', x: 4, y: 0, w: 2, h: 7, static: true},
